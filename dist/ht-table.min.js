 ...
 * License: 
 */
var app=angular.module("ht.table",["ui.bootstrap","naturalSort"]);app.directive("htTable",function(){return{templateUrl:"ht-table.html",scope:{htTable:"="},controller:["$scope","orderByFilter","naturalService",function(e,t){function n(e){return{rowClick:a(e,"rowClick"),expand:a(e,"expand"),postSorting:a(e,"postSorting"),checkedRows:a(e,"checked"),init:a(e,"init")}}function a(e,t){return angular.isDefined(e[t])?e[t]:function(){}}function i(){for(var e=0,t=k.fields.length;t>e;e++){var n=k.fields[e];angular.isDefined(n.sort)&&D.push({field:n.value,sort:n.sort}),n.visible=angular.isUndefined(n.visible)}}function l(){if(0!==T.length||!angular.isFunction(x.init)){for(var e=[],n=0,a=D.length;a>n;n++){var i=D[n],l="";l="asc"==i.sort?"+":"-",l+=i.field,e.push(l)}var r=D.length?t(T,e):T,o=k.pagination;angular.isFunction(x.init)&&(x.init(r,o),x.init=null),o.total=r.length,k.data=o.itemsPerPage?r.slice((o.current-1)*o.itemsPerPage,o.current*k.pagination.itemsPerPage):r}}function r(){k.pagination.current=1,l()}function o(e){return M=e,x.rowClick(e)}function s(e){return x.expand(e)}function u(){this.reloadTable()}function d(){return parseInt(k.pagination.total/k.pagination.itemsPerPage)+1}function c(e){return k.selectMultiple&&e.checked||e==M?C:""}function g(e){for(var t=0;t<D.length;t++)if(e.value==D[t].field)return"asc"==D[t].sort?"ht-table-icon-up":"ht-table-icon-down";return""}function p(e){for(var t=0;t<D.length;t++)if(D[t].field==e.value)return t;return null}function f(e,t){var n=t.shiftKey,a=p(e),i={};if(i=null===a?{field:e.value,sort:"asc"}:D[a],null!==a){var r=i.sort;"asc"==r?(D[a].sort="desc",n||(D=[D[a]])):n?D.splice(a,1):D=[]}else n?D.push(i):D=[i];x.postSorting(D,k.pagination),l()}function b(){for(var e=1,t=0,n=k.fields.length;n>t;t++){var a=k.fields[t];a.visible&&e++}return k.selectMultiple&&e++,e}function h(){var e=m();x.checkedRows(e)}function v(){for(var e=0,t=k.fields.length;t>e;e++)if(angular.isDefined(k.fields[e].type)&&"sum"==k.fields[e].type)return!0;return!1}function m(){for(var e=[],t=0,n=k.data.length;n>t;t++){var a=k.data[t];angular.isDefined(a.checked)&&a.checked&&e.push(a)}return e}function P(e){var t=0,n=m(),a=n.length;a||(n=T);for(var i=0;a>i;i++){var l=n[i];t+=l[e]}return t}function w(e,t){for(var n=e.split("."),a=t,i=0,l=n.length;l>i;i++){var r=n[i];if(null===a||!a.hasOwnProperty(r))return"";a=a[r]}return a}function y(e){return"template"==e.type}var k=this,S=e.htTable,x=n(S);k.id=angular.isDefined(S.id)?S.id:"table",k.class=angular.isDefined(S.class)?S.class:[],k.selectMultiple=angular.isDefined(S.selectMultiple)?S.selectMultiple:!1;var C=angular.isDefined(S.active)?S.active:"",T=S.data,M=null;k.fields=S.fields,k.pagination={total:0,current:1,itemsPerPage:10};var D=[];k.data=T,k.reloadTable=l,k.expand=o,k.show=s,k.pageChanged=u,k.pages=d,k.rowStyle=c,k.getFieldClass=g,k.findField=p,k.changeSorting=f,k.countColumns=b,k.checkedChange=h,k.hasSum=v,k.getCheckedElements=m,k.sum=P,k.getValue=w,k.isTemplate=y,k.updatePagination=r,i(),l(),e.$watch("htTable",function(e,t){e!=t&&(T=e.data,l())},!0)}],controllerAs:"table"}}),/*!
