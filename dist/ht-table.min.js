 ...
 * License: 
 */
var app=angular.module("ht.table",["ui.bootstrap","naturalSort","ngSanitize","ngCsv"]);app.directive("htTable",function(){return{templateUrl:"ht-table.html",scope:{htTable:"="},controller:["$scope","$filter","$rootScope",function(e,t,n){function a(e){return{rowClick:i(e,"rowClick"),expand:i(e,"expand"),postSorting:i(e,"postSorting"),checkedRows:i(e,"checked"),init:i(e,"init")}}function i(e,t){return angular.isDefined(e[t])?e[t]:function(){}}function l(){for(var e=0,t=x.fields.length;t>e;e++){var n=x.fields[e];angular.isDefined(n.sort)&&V.push({field:n.value,sort:n.sort}),angular.isUndefined(n.visible)&&(n.visible=!0)}}function r(){if(0!==M.length||!angular.isFunction(T.init)){for(var e=[],n=0,a=V.length;a>n;n++){var i=V[n],l="";l="asc"==i.sort?"+":"-",l+=i.field,e.push(l)}var r=V.length?t("natural")(M,e):M,o=x.pagination;angular.isFunction(T.init)&&(T.init(r,o),T.init=null),o.total=r.length,x.data=o.itemsPerPage?r.slice((o.current-1)*o.itemsPerPage,o.current*x.pagination.itemsPerPage):r}}function o(){x.pagination.current=1,r()}function u(e){return A=e,T.rowClick(e)}function s(e){return T.expand(e)}function c(){this.reloadTable()}function d(){return parseInt(x.pagination.total/x.pagination.itemsPerPage)+1}function g(e){return x.selectMultiple&&e.checked||e==A?$:""}function f(e){for(var t=0;t<V.length;t++)if(e.value==V[t].field)return"asc"==V[t].sort?"ht-table-icon-up":"ht-table-icon-down";return""}function p(e){for(var t=0;t<V.length;t++)if(V[t].field==e.value)return t;return null}function b(e,t){var n=t.shiftKey,a=p(e),i={};if(i=null===a?{field:e.value,sort:"asc"}:V[a],null!==a){var l=i.sort;"asc"==l?(V[a].sort="desc",n||(V=[V[a]])):n?V.splice(a,1):V=[]}else n?V.push(i):V=[i];T.postSorting(V,x.pagination),r()}function h(){for(var e=1,t=0,n=x.fields.length;n>t;t++){var a=x.fields[t];a.visible&&e++}return x.selectMultiple&&e++,e}function v(){D=!0;var e=P();T.checkedRows(e)}function m(){for(var e=0,t=x.fields.length;t>e;e++)if(angular.isDefined(x.fields[e].type)&&"sum"==x.fields[e].type)return!0;return!1}function P(){for(var e=[],t=0,n=x.data.length;n>t;t++){var a=x.data[t];angular.isDefined(a.checked)&&a.checked&&e.push(a)}return e}function y(){for(var e=0,t=x.data.length;t>e;e++)x.data[e].checked=!1}function w(e){var t=0,n=P();n.length||(n=M);for(var a=n.length,i=0;a>i;i++){var l=n[i];t+=l[e]}return t}function S(e,n){if(!angular.isUndefined(e.value)){for(var a=e.value,i=a.split("."),l=n,r=0,o=i.length;o>r;r++){var u=i[r];if(null===l||!l.hasOwnProperty(u))return"";l=l[u]}return angular.isDefined(e.filter)&&(l=t(e.filter)(l)),l}}function k(e){return"template"==e.type}var x=this,C=e.htTable;C.reset=o,C.reload=r,C.clearSelect=y;var T=a(C),D=!1;x.id=angular.isDefined(C.id)?C.id:"table",x.class=angular.isDefined(C.class)?C.class:[],x.selectMultiple=angular.isDefined(C.selectMultiple)?C.selectMultiple:!1;var $=angular.isDefined(C.active)?C.active:"",M=C.data,A=null;x.fields=C.fields,x.pagination={total:0,current:1,itemsPerPage:10};var V=[];x.data=M,x.reloadTable=r,x.expand=u,x.show=s,x.pageChanged=c,x.pages=d,x.rowStyle=g,x.getFieldClass=f,x.findField=p,x.changeSorting=b,x.countColumns=h,x.checkedChange=v,x.hasSum=m,x.getCheckedElements=P,x.sum=w,x.getValue=S,x.isTemplate=k,x.updatePagination=o,l(),r(),e.$watch("htTable",function(e,t){return e!=t?D?(D=!1,void 0):(M=e.data,void 0):void 0},!0),n.$on("ht.table.refresh",o),x.export=function(){for(var e=M,t=e.length,n=[],a=0;t>a;a++){for(var i=[],l=0;l<x.fields.length;l++){var r=x.fields[l];r.visible&&!angular.isUndefined(r.value)&&i.push(S(r,e[a]))}n.push(i)}return n},x.exportHeader=function(){for(var e=[],t=0;t<x.fields.length;t++){var n=x.fields[t];n.visible&&!angular.isUndefined(n.value)&&e.push(n.name)}return e}}],controllerAs:"table"}}).filter("natural",["$parse","naturalService",function(e,t){function n(e){if("function"==typeof e)e=!0;else if(e&&0!==e.length){var t=angular.lowercase(""+e);e=!("f"==t||"0"==t||"false"==t||"no"==t||"n"==t||"[]"==t)}else e=!1;return e}function a(e){return e&&e.document&&e.location&&e.alert&&e.setInterval}function i(e,t,n){var a=[];return angular.forEach(e,function(e,i,l){a.push(t.call(n,e,i,l))}),a}function l(e){if(null===e||a(e))return!1;var t=e.length;return 1===e.nodeType&&t?!0:angular.isString(e)||angular.isArray(e)||0===t||"number"==typeof t&&t>0&&t-1 in e}var r=[].slice;return function(a,o,u){function s(e,t){for(var n=0;n<o.length;n++){var a=o[n](e,t);if(0!==a)return a}return 0}function c(e,t){return n(t)?function(t,n){return e(n,t)}:e}function d(e,n){var a=typeof e,i=typeof n;return a==i?(angular.isDate(e)&&angular.isDate(n)&&(e=e.valueOf(),n=n.valueOf()),"string"==a&&(e=t.naturalValue(e.toLowerCase()),n=t.naturalValue(n.toLowerCase())),e===n?0:n>e?-1:1):i>a?-1:1}return l(a)?(o=angular.isArray(o)?o:[o],0===o.length&&(o=["+"]),o=i(o,function(t){var n=!1,a=t||identity;if(angular.isString(t)){if(("+"==t.charAt(0)||"-"==t.charAt(0))&&(n="-"==t.charAt(0),t=t.substring(1)),""===t)return c(function(e,t){return d(e,t)},n);if(a=e(t),a.constant){var i=a();return c(function(e,t){return d(e[i],t[i])},n)}}return c(function(e,t){return d(a(e),a(t))},n)}),r.call(a).sort(c(s,u))):a}}]),/*!
