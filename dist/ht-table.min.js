 ...
 * License: 
 */
var app=angular.module("ht.table",["ui.bootstrap","naturalSort"]);app.directive("htTable",function(){return{templateUrl:"ht-table.html",scope:{htTable:"="},controller:["$scope","$filter",function(e,t){function n(e){return{rowClick:a(e,"rowClick"),expand:a(e,"expand"),postSorting:a(e,"postSorting"),checkedRows:a(e,"checked"),init:a(e,"init")}}function a(e,t){return angular.isDefined(e[t])?e[t]:function(){}}function i(){for(var e=0,t=k.fields.length;t>e;e++){var n=k.fields[e];angular.isDefined(n.sort)&&$.push({field:n.value,sort:n.sort}),angular.isUndefined(n.visible)&&(n.visible=!0)}}function l(){if(0!==D.length||!angular.isFunction(C.init)){for(var e=[],n=0,a=$.length;a>n;n++){var i=$[n],l="";l="asc"==i.sort?"+":"-",l+=i.field,e.push(l)}var r=$.length?t("natural")(D,e):D,o=k.pagination;angular.isFunction(C.init)&&(C.init(r,o),C.init=null),o.total=r.length,k.data=o.itemsPerPage?r.slice((o.current-1)*o.itemsPerPage,o.current*k.pagination.itemsPerPage):r}}function r(){k.pagination.current=1,l()}function o(e){return M=e,C.rowClick(e)}function u(e){return C.expand(e)}function s(){this.reloadTable()}function c(){return parseInt(k.pagination.total/k.pagination.itemsPerPage)+1}function g(e){return k.selectMultiple&&e.checked||e==M?T:""}function d(e){for(var t=0;t<$.length;t++)if(e.value==$[t].field)return"asc"==$[t].sort?"ht-table-icon-up":"ht-table-icon-down";return""}function f(e){for(var t=0;t<$.length;t++)if($[t].field==e.value)return t;return null}function p(e,t){var n=t.shiftKey,a=f(e),i={};if(i=null===a?{field:e.value,sort:"asc"}:$[a],null!==a){var r=i.sort;"asc"==r?($[a].sort="desc",n||($=[$[a]])):n?$.splice(a,1):$=[]}else n?$.push(i):$=[i];C.postSorting($,k.pagination),l()}function b(){for(var e=1,t=0,n=k.fields.length;n>t;t++){var a=k.fields[t];a.visible&&e++}return k.selectMultiple&&e++,e}function h(){x=!0;var e=m();C.checkedRows(e)}function v(){for(var e=0,t=k.fields.length;t>e;e++)if(angular.isDefined(k.fields[e].type)&&"sum"==k.fields[e].type)return!0;return!1}function m(){for(var e=[],t=0,n=k.data.length;n>t;t++){var a=k.data[t];angular.isDefined(a.checked)&&a.checked&&e.push(a)}return e}function P(e){var t=0,n=m();n.length||(n=D);for(var a=n.length,i=0;a>i;i++){var l=n[i];t+=l[e]}return t}function y(e,t){for(var n=e.split("."),a=t,i=0,l=n.length;l>i;i++){var r=n[i];if(null===a||!a.hasOwnProperty(r))return"";a=a[r]}return a}function w(e){return"template"==e.type}var k=this,S=e.htTable,C=n(S),x=!1;k.id=angular.isDefined(S.id)?S.id:"table",k.class=angular.isDefined(S.class)?S.class:[],k.selectMultiple=angular.isDefined(S.selectMultiple)?S.selectMultiple:!1;var T=angular.isDefined(S.active)?S.active:"",D=S.data,M=null;k.fields=S.fields,k.pagination={total:0,current:1,itemsPerPage:10};var $=[];k.data=D,k.reloadTable=l,k.expand=o,k.show=u,k.pageChanged=s,k.pages=c,k.rowStyle=g,k.getFieldClass=d,k.findField=f,k.changeSorting=p,k.countColumns=b,k.checkedChange=h,k.hasSum=v,k.getCheckedElements=m,k.sum=P,k.getValue=y,k.isTemplate=w,k.updatePagination=r,i(),l(),e.$watch("htTable",function(e,t){if(e!=t){if(x)return x=!1,void 0;D=e.data,r()}},!0)}],controllerAs:"table"}}).filter("natural",["$parse","naturalService",function(e,t){function n(e){if("function"==typeof e)e=!0;else if(e&&0!==e.length){var t=angular.lowercase(""+e);e=!("f"==t||"0"==t||"false"==t||"no"==t||"n"==t||"[]"==t)}else e=!1;return e}function a(e){return e&&e.document&&e.location&&e.alert&&e.setInterval}function i(e,t,n){var a=[];return angular.forEach(e,function(e,i,l){a.push(t.call(n,e,i,l))}),a}function l(e){if(null===e||a(e))return!1;var t=e.length;return 1===e.nodeType&&t?!0:angular.isString(e)||angular.isArray(e)||0===t||"number"==typeof t&&t>0&&t-1 in e}var r=[].slice;return function(a,o,u){function s(e,t){for(var n=0;n<o.length;n++){var a=o[n](e,t);if(0!==a)return a}return 0}function c(e,t){return n(t)?function(t,n){return e(n,t)}:e}function g(e,n){var a=typeof e,i=typeof n;return a==i?(angular.isDate(e)&&angular.isDate(n)&&(e=e.valueOf(),n=n.valueOf()),"string"==a&&(e=t.naturalValue(e.toLowerCase()),n=t.naturalValue(n.toLowerCase())),e===n?0:n>e?-1:1):i>a?-1:1}return l(a)?(o=angular.isArray(o)?o:[o],0===o.length&&(o=["+"]),o=i(o,function(t){var n=!1,a=t||identity;if(angular.isString(t)){if(("+"==t.charAt(0)||"-"==t.charAt(0))&&(n="-"==t.charAt(0),t=t.substring(1)),""===t)return c(function(e,t){return g(e,t)},n);if(a=e(t),a.constant){var i=a();return c(function(e,t){return g(e[i],t[i])},n)}}return c(function(e,t){return g(a(e),a(t))},n)}),r.call(a).sort(c(s,u))):a}}]),/*!
